...
public class CraftyBlocker extends JavaPlugin
{
    ...
    {
        moon.print("Loading Dash Craft Blocker 1.2 ....");
        ...
        moon.print("Version: 1.2");
        moon.print("Email: KvinneKraft@protonmail.com");
        
        moon.print("Dash Craft Blocker 1.2 has been loaded!");
    };
    ...
    class EventsHandler implements Listener
    {
        ...
        public void onCraft(PrepareItemCraftEvent e)
        {
            ...
            if((e.getRecipe() != null) && (!e.getRecipe().getResult().getType().equals(Material.AIR)))
            {
