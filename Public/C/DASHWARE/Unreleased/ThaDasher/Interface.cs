...
namespace ThaDasher
{
    ...
    {
	private readonly static string FORMAT = "Hey there, I am unfortunate to tell you but an error has occurred which has caused this application to be useless right now.\r\n\r\nYou can help me prevent this from happening in the future by sending me the following error code at KvinneKraft@protonmail.com:\r\n{\r\n%m%\r\n}\r\n\r\nRegardless, Thank you.\r\n\r\nClick OK to close this application or click cancel to restart this application.";

	private readonly static DashControls CONTROL = new DashControls();
	...
	private class TARGETCONTAINER
	{
	    ...
	    readonly public static Label IP_LAB = new Label();
	    readonly public static Label PO_LAB = new Label();
	    readonly public static Label DR_LAB = new Label();
	...
	{
	    readonly public static Label HTTP_TITLE = new Label() { Text = "HTTP Methods", TextAlign = ContentAlignment.MiddleCenter };
	    
	    readonly public static Button HTTP_DASHLORIS = new Button();
	    readonly public static Button HTTP_SLOWLORIS = new Button();
	    readonly public static Button HTTP_FLOOD = new Button();
	    readonly public static Button HTTP_POST = new Button();
	    readonly public static Button HTTP_PUT = new Button();
	    readonly public static Button HTTP_GET = new Button();

	    readonly public static int httpcount = 6;

	    readonly public static Label TCP_TITLE = new Label() { Text = "TCP Methods", TextAlign = ContentAlignment.MiddleCenter };
	    
	    readonly public static Button TCP_LONGSOCKS = new Button();
	    readonly public static Button TCP_SOCKS = new Button();
	    readonly public static Button TCP_FLOOD = new Button();
	    readonly public static Button TCP_WAVES = new Button();
	    
	    readonly public static int tcpcount = 4;

	    readonly public static Label UDP_TITLE = new Label() { Text = "UDP Methods", TextAlign = ContentAlignment.MiddleCenter };
	    
	    readonly public static Button UDP_OVERLOAD = new Button();
	    readonly public static Button UDP_FLOOD = new Button();
	    readonly public static Button UDP_WAVES = new Button();
	    readonly public static Button UDP_HAM = new Button();
	    
	    readonly public static int udpcount = 4;
	    ...
	    readonly public static Form DIALOG = new Form();
	    ...
	    readonly public static PictureBox CONTAINER = new PictureBox();
	    readonly public static PictureBox PONY1 = new PictureBox();
	    readonly public static PictureBox PONY2 = new PictureBox();

	    readonly public static Button METHODS = new Button();

	    readonly public static Label METHOD_TITLE = new Label() { TextAlign = ContentAlignment.MiddleCenter };

	    public static void InitializeMCon(Form TOP)
	    {
		try
		{
		    var CONTAINER_SIZE = new Size(CONTAINER.Width, 100);
		    var CONTAINER_LOCA = new Point(CONTAINER.Left, CONTAINER.Top + CONTAINER.Height + 5);
		    var CONTAINER_BCOL = CONTAINER.BackColor;
	...
	private class LOGCONTAINER
	{
		...
		try
		{
		    var CONTAINER_SIZE = new Size(TOP.Width - 2 - CONTAINER.Left - 14 - CONTAINER.Width, CONTAINER.Height + 5 + SETTINGSCONTAINER.CONTAINER.Height);
		    var CONTAINER_LOCA = new Point(TOP.Width - 1 - CONTAINER_SIZE.Width - 8, CONTAINER.Top);
		    var CONTAINER_COLA = CONTAINER.BackColor;
	...
	private class TASKBARCONTAINER
	{
	    ...
	    readonly public static Button ABOUT = new Button();
	    readonly public static Button START = new Button();
	    readonly public static Button PORTS = new Button();
	...
	private class LOGINDIALOG
	{
	    ...
	    readonly public static TextBox IUSERNAME = new TextBox();
	    readonly public static TextBox IPASSWORD = new TextBox();

	    readonly public static Label USERNAME = new Label();
	    readonly public static Label PASSWORD = new Label();
		...
		CONTROL.Button(CONTAINER, LOGIN, BUTTON_SIZE, BUTTON_LOCA, BUTTON_BCOL, BUTTON_FCOL, 1, 11, "Login", Color.Empty);
		TOOL.Round(LOGIN, 6);

		BUTTON_LOCA.X += BUTTON_SIZE.Width + 10;

		CONTROL.Button(CONTAINER, HELP, BUTTON_SIZE, BUTTON_LOCA, BUTTON_BCOL, BUTTON_FCOL, 1, 11, "Help", Color.Empty);
		TOOL.Round(HELP, 6);
	    }
